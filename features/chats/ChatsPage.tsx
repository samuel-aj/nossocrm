...
export const ChatsPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* +30px de largura: nome de grupo costuma ter prefixo ("AJ Marketing - ...")
          e cortava antes de chegar na parte que identifica o grupo. */}
      <aside className={`${selected ? 'hidden md:flex' : 'flex'} w-full md:w-[390px] lg:w-[410px] shrink-0 flex-col border-r border-slate-200 dark:border-white/10 bg-white dark:bg-dark-card`}>
        {/* Cabeçalho */}

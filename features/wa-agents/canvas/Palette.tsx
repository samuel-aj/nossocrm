      ...
      {STEP_TYPES.map((type) => {
        ...
        return (
          <button
            ...
            className="shrink-0 inline-flex items-center gap-2 px-2.5 py-2 rounded-lg text-sm text-left text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/10 cursor-grab active:cursor-grabbing transition-colors"
          >

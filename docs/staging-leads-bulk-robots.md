...
## Banco e publicação
Sincronizadas no staging as três migrações 20260918120000, 20260918130000 e 20260918160732, que existiam parcialmente fora do histórico. Aplicadas 20260923212346, 20260923212610 e 20260923214413 (o gatilho de rodízio não fica exposto como RPC). deal_items e deal_notes habilitados no Realtime.
...
- Teste HTTP autenticado com dados temporários: criação manual, revisão sem executar, fila, repetição idempotente, execução real de robô que só encerra, bloqueios 401/403, eventos reais de contatos/deals/deal_items e limpeza dos fixtures.

...
const routeImports = {
  ...
  chats: () => import('@/features/chats/ChatsPage'),
  modelos: () => import('@/features/templates/TemplatesPage'),
  conexao: () => import('@/features/whatsapp/WhatsAppConnectionPage'),
  ...
  tutorial: () => import('@/features/tutorial/TutorialPage'),
} as const;

              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    connection_id: { type: 'string', description: 'Por qual número iniciar (GET /whatsapp/connections). Omitido = o PRIMEIRO número do robô. O robô é exclusivo dos números escolhidos nele: pedir outro devolve 409 BOT_CONNECTION_NOT_ALLOWED com a lista permitida.' },
                  },
                  required: ['phone', 'action'],
                },
                examples: {
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    ai_context: { type: 'string', nullable: true, description: 'Contexto sobre o lead para o agente de IA (ele lê ao entrar na conversa, mesmo sem ativar a IA agora). null limpa.' },

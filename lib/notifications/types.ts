...
export const DEFAULT_PREFERENCES: Preferences = {
  messages: false, scope: 'own', leads: false, boardIds: [], desktop: false, sound: false,
  soundType: 'current', volume: 40,
};
export interface Notice { id: string; kind: 'message' | 'lead'; title: string; message: string; href: string; createdAt: string }
